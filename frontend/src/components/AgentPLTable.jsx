        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {agents.map((agent, idx) => {
              ...
              return (
                <tbody key={agent.id} style={{ animation: `fadeUp 300ms cubic-bezier(0.16,1,0.3,1) both ${idx * 50}ms` }}>
                  <tr
                    ...
                    style={{
                      ...
                      e.currentTarget.style.background = isExpanded ? 'rgba(200,242,100,0.05)' : 'transparent';
                    }}
                  >
                  ...
                  {isExpanded && <tr style={{ animation: 'fadeUp 300ms cubic-bezier(0.16,1,0.3,1) both' }}><td colSpan="7"><AgentRowExpanded agent={agent} /></td></tr>}
                </tbody>
              );
            })}
          </tbody>
